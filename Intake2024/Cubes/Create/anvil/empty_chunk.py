...
class EmptyChunk:
    ...
    tile_entities: :class:`nbt.TAG_Compound`
        List of all the tile entities in this chunk
    """
    ...
    def __init__(self, x: int, z: int):
        ...
        self.version = 1976
        self.tile_entities = nbt.TAG_List(type=nbt.TAG_Compound)
    ...
    def add_tile_entity(self, tile_entity: nbt.TAG_Compound):
        """
        ...
        tile_entity
            Tile entity to add
        """
        self.tile_entities.tags.append(tile_entity)
